     ...
     <>
        ...
        `}</style>
            ...
            <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative">
                <div className="w-full bg-blue-500/20 py-8 mb-6">
                    <Title title="What Our Customers Say" subTitle="Hear from our satisfied customers and discover why discerning travelers choose us for their luxury accommodations around the world" />
                </div>
