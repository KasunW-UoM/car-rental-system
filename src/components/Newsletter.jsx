...
const Newsletter = () => {
  return (
    <>
            ...
            `}</style>
            <div className="max-w-5xl py-16 md:pl-20 md:w-full mx-2 md:mx-auto p-4 flex flex-col md:flex-row items-center justify-between text-left bg-gradient-to-r from-[#0558FF] to-[#4D9FFF] rounded-2xl md:p-10 text-white">
                <div>
                    <div>
                        <p className="text-blue-100">Trusted by 12k+ Customers in our Service</p>
                ...
                <div className="flex items-center gap-2 bg-blue-700 max-md:mt-6 pl-4 h-11 text-sm rounded-full overflow-hidden">
                    ...
                    className="outline-none h-11 bg-transparent text-white placeholder:text-blue-200" />
                    <button className="px-6 h-10 mr-1 rounded-full border border-yellow-400 bg-yellow-400 hover:bg-yellow-500 transition-all text-gray-900 font-semibold">Subscribe
                    </button>
                </div>
            </div>
        </>
