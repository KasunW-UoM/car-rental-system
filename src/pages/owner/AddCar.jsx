...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title='Add New Car' subTitle='Field in details to list  new car for
      ...
      text-sm mt-6 max-w-xl'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <div className='flex flex-col w-full'>
            <label>Brand</label>
            <input type="text" placeholder='e.g. BMW, Hiyondai, Suzuki, Audi, ...'  required
            className='px-3 py-2 border border-borderColor rounded-md outline-none' value={car.brand} 
            onChange={e=> setCar({...car, brand: e.target.value})}/>
          </div>

          <div className='flex flex-col w-full'>
            <label>Model</label>
            <input type="text" placeholder='e.g. Eon, X5, M4, WagonR, ...'  required
            className='px-3 py-2 border border-borderColor rounded-md outline-none' value={car.model} 
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          <div className='flex flex-col w-full'>
            ...
            className='px-3 py-2 border border-borderColor rounded-md outline-none' value={car.year} 
            onChange={e=> setCar({...car, year: e.target.value})}/>
          </div>
         
          <div className='flex flex-col w-full'>
            <label>Daily Price ({currency})</label>
            <input type="number" placeholder='LKR 2000'  required
            className='px-3 py-2 border border-borderColor rounded-md outline-none' value={car.pricePerDay} 
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            ...
            className='px-3 py-2 border border-borderColor rounded-md outline-none' value={car.seating_capacity} 
        ...
        <div className='flex flex-col w-full'>
          <div className='flex flex-col w-full'>
            ...
            <textarea rows={5} placeholder='e.g. A luxurious SUV With a specious interior and a powerfull engine.'  required
            className='px-3 py-2 border border-borderColor rounded-md outline-none' value={car.description} 
